...
template<> OCULUSXRANCHORS_API UScriptStruct* StaticStruct<FOculusXRRoomLayout>()
{
	...
	struct Z_CompiledInDeferFile_FID_limqi_Documents_Unreal_Projects_CS3247_Lightbringer_Plugins_MetaXR_Source_OculusXRAnchors_Public_OculusXRAnchorTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_limqi_Documents_Unreal_Projects_CS3247_Lightbringer_Plugins_MetaXR_Source_OculusXRAnchors_Public_OculusXRAnchorTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_limqi_Documents_Unreal_Projects_CS3247_Lightbringer_Plugins_MetaXR_Source_OculusXRAnchors_Public_OculusXRAnchorTypes_h_Statics::ScriptStructInfo[] = {
		...
		{ FOculusXRRoomLayout::StaticStruct, Z_Construct_UScriptStruct_FOculusXRRoomLayout_Statics::NewStructOps, TEXT("OculusXRRoomLayout"), &Z_Registration_Info_UScriptStruct_OculusXRRoomLayout, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOculusXRRoomLayout), 2692632459U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_limqi_Documents_Unreal_Projects_CS3247_Lightbringer_Plugins_MetaXR_Source_OculusXRAnchors_Public_OculusXRAnchorTypes_h_720842798(TEXT("/Script/OculusXRAnchors"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_limqi_Documents_Unreal_Projects_CS3247_Lightbringer_Plugins_MetaXR_Source_OculusXRAnchors_Public_OculusXRAnchorTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_limqi_Documents_Unreal_Projects_CS3247_Lightbringer_Plugins_MetaXR_Source_OculusXRAnchors_Public_OculusXRAnchorTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_limqi_Documents_Unreal_Projects_CS3247_Lightbringer_Plugins_MetaXR_Source_OculusXRAnchors_Public_OculusXRAnchorTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_limqi_Documents_Unreal_Projects_CS3247_Lightbringer_Plugins_MetaXR_Source_OculusXRAnchors_Public_OculusXRAnchorTypes_h_Statics::EnumInfo));
